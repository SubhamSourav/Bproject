...
const productSchema = new mongoose.Schema({
    ...
    category:{
        type:String,
        required:[true,'please select category from short_sleeves, long-sleeves, sweat-shirts,hoodies'],
        enum:{
            values:[
                'shortsleeves',
                'longsleeves',
            ...
            message:'please select category from short_sleeves, long-sleeves, sweat-shirts,hoodies'
        },
    },
    brand:{
        type: String,
